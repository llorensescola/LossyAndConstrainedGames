...
#The following function returns the upper bound corresponding to the level k=1 on the optimal winning probability given the constraint imposed by the parameter epsilon
